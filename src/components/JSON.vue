  ...
  <li v-for="work in allFamousWorks" :key="work">
    {{ work }}
      ...
      <!-- TODO: CODE TO RENDER LIST OF AUSTEN'S WORKS HERE -->
       <ul>
        <li v-for="aWork in austen.famousWorks" :key="austen.id">
        {{ aWork.title }}
        </li>
       </ul>
    </section>
    ...
    <section class="lab-section">
      ...
      <!-- TODO: CODE TO RENDER LIST OF STORE TYPES HERE -->
       <ul>
        <li v-for="value,key in bookstores.storeTypes" :key="value.index">
          {{ key }}: {{ value }}
        </li>
      </ul>
      ...
      <!-- TODO: CODE TO RENDER LIST OF OPENING HOURS HERE -->
       <ul>
        <li v-for="hour,key in bookstores.openingHours">{{ key }}: {{ hour.open }}--{{ hour.close }}</li>
       </ul>

      <h3>Working with Arrays in Objects</h3>
      <!-- Activity 12: Get the top sellers from the bookstores object. -->
      <!-- TODO: CODE TO GET TOP SELLERS HERE -->
      <p >We operate in: <span v-for="value in bookstores.countries">{{value}}&nbsp</span></p>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="author in authors" :class="{'highlight':author.name==='George Orwell'}" :key="author.id">{{ author.name }}</li>
      </ul>
...
// console.log(authors.filter((author)=>author.birthYear>1850),111111)
...
console.log(authors.filter((author)=>author.name==="George Orwell"),"owell")

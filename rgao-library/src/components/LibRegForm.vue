      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            ></textarea>
            <div v-if="errors.reason" :class="errClass">{{ errors.reason }}</div>
          </div>
          <!-- Suburb -->
          <div class="mb-3">
...
const validateConfirmPassword = (blur) => {
  if (!formData.value.confirmPassword) {
    ...
    if (blur) {
      errors.value.confirmPassword = 'Password is not match.'
    }
  } else {
...
const validateResident = () => {
  // console.log(formData.value.isAustralian, !formData.value.isAustralian)
